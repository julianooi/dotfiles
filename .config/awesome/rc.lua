...
beautiful.init("/home/julianooi/.config/awesome/themes/cesious/theme.lua")
...
local myexitmenu = {
	...
	{ "hibernate", "systemctl hibernate", "/usr/share/icons/Arc-Maia/actions/24@2x/gnome-session-hibernate.png" },
	{
		"reboot",
		"systemctl reboot",
		"/usr/share/icons/Arc-Maia/actions/24@2x/view-refresh.png",
	},
	{
		"shutdown",
		"poweroff",
		"/usr/share/icons/Arc-Maia/actions/24@2x/system-shutdown.png",
	},
}
...
globalkeys = gears.table.join(
	...
	end, { description = "capture a screenshot of active window", group = "screenshot" }),
	...
	end, { description = "shutdown", group = "power" })
)
...
clientkeys = gears.table.join(
	...
	awful.key({}, "XF86AudioLowerVolume", function()
		awful.util.spawn("pamixer -d 5 --allow-boost --set-limit 200", false)
	end, { description = "reduce volume", group = "media control" }),
	awful.key({}, "XF86AudioRaiseVolume", function()
		awful.util.spawn("pamixer -i 5 --allow-boost --set-limit 200", false)
	end, { description = "increase volume", group = "media control" }),
	awful.key({}, "XF86AudioMute", function()
		awful.util.spawn("pamixer -t", false)
	end, { description = "toggle mute", group = "media control" }),
	-- Media Keys
